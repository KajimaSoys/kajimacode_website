# Generated by Django 4.1.5 on 2023-02-24 13:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_short_ru', models.TextField(blank=True, max_length=2500, verbose_name='Описание короткое (рус.)')),
                ...
                ('group', models.ManyToManyField(blank=True, to='core.group', verbose_name='Группа')),
            ],
            options={
                'verbose_name': 'Проект',
